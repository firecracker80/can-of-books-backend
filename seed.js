...
async function seed() {
  await Books.create({
    ...
    status: true,
    img: 'http://www.patriciacornwell.com/wp-content/uploads/16.Scarpetta.car_1.jpg'
  });
  ...
  await Books.create({
    ...
    status: false,
    img: 'http://www.patriciacornwell.com/wp-content/uploads/01.Postmortem.car_1.jpg'
  });
  ...
  await Books.create({
    ...
    status: true,
    img: 'http://www.patriciacornwell.com/wp-content/uploads/09.Point-of-Origin.car_1.jpg'
  });
